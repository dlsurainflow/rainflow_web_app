...
export const Home = () => {
  ...
  return (
    ...
    <Modal show = {isOpen} onHide ={handleClose}  dialogClassName="modal-main-web"  animation={false}>
    ...
    <Pane flex="1" height ={windowHeight * 0.8} overflow ={"auto"} background="#F9F9FB" paddingX={5} margin ={0}>
