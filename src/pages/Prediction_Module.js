...
export const PredictionModule = (props) => {
        ...
        .then((response) => {
          if (response.status === 200)
            response.json().then((data) => {
              ...
              let _FD_H = FD_H;
              _FD_H.push({
                time: dateTime.setHours(dateTime.getHours() + T_A / 60),
                value: data.FD_H.toFixed(2),
              });
              setFD_H(_FD_H);
              let _FD_M = FD_M;
              _FD_M.push({
                time: dateTime.setHours(dateTime.getHours() + T_A / 60),
                value: data.FD_M.toFixed(2),
              });
              setFD_M(_FD_M);
              let _FD_L = FD_L;
              _FD_L.push({
              ...
              setFD_L(_FD_L);
              setDateTime(dateTime.setHours(dateTime.getHours() + T_A / 60));
            });
        })
  ...
  return (
    <>
          ...
          <Modal.Title>
            <Pane flex="1" flexDirection="row" backgroundColor="#fff">
              <Pane display="inline-flex" flexDirection="column" padding={10}>
                <Heading size={700}>{editedArea}</Heading>
      ...
      <Box width="auto" className={classes.snapshotBox} box-shadow={3}>
        <TextField
          id="filled-input"
          label="Hours"
          value={T_A}
      ...
      {/* Corner Legend */}
      <Box width="50%" className={classes.cornerLegend} box-shadow={3}>
      ...
      >
        ...
        >
          <DialogTitle id="form-dialog-title">
            Add Rain Profile to {paramsEdited}
          </DialogTitle>
          <DialogContent>
            <DialogContentText>
        ...
        <Dialog
          open={inputOpenFlood}
          onClose={handleInputCloseFlood}
          aria-labelledby="form-dialog-title"
        >
          <DialogTitle id="form-dialog-title">
            Change flood level in {editedArea}
          </DialogTitle>
          <DialogContent>
            <TextField
              autoFocus
        ...
        >
          <Popup>
            ...
            <Button
              onClick={() => {
                setAreaAddress(
                  "Concepcion Uno, Marikina, Metro Manila, 1807, Philippines"
                );
                setRaftInfo({
                  RA1: LSinfo.RA1,
                  RA2: LSinfo.RA2,
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Butihin Street, Concepcion Uno, Marikina, Metro Manila, 1807, Philippines"
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Bayan-Bayanan Avenue, San Isidro Village, Concepcion Uno, Marikina, Metro Manila, 1807, Philippines"
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "E. Santos, Better Homes Subdivision, Concepcion Uno, Marikina, Metro Manila, 1807, Philippines"
            );
        ...
        >
          <Popup>
            ...
            <Button
              onClick={() => {
                setAreaAddress(
                  "Marikina Heights, Marikina, Metro Manila, 1810, Philippines"
                );
                setRaftInfo({
                  RA1: MSinfo.RA1,
                  RA2: MSinfo.RA2,
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Dao, J. J. Carlos PAG-IBIG Subdivision, Marikina Heights, Marikina, Metro Manila, 1810, Philippines"
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Saint Marcellin Champagnat, Marikina Heights, Marikina, Metro Manila, 1810, Philippines"
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "General Ordonez, Sunnyville 2, Marikina Heights, Marikina, Metro Manila, 1810, Philippines"
            );
        ...
        >
          <Popup>
            ...
            <Button
              onClick={() => {
                setAreaAddress(
                  "San Mateo, Rizal, Calabarzon, 1850, Philippines"
                );
                setRaftInfo({
                  RA1: HSinfo.RA1,
                  RA2: HSinfo.RA2,
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Langka Street, AFP Housing, Timberland Heights, Silangan, Rizal, Calabarzon, 1873, Philippines "
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Santa Barbara Villas 1 Phase 1, Timberland Heights, Santo Niño, Rizal, Calabarzon, 1850, Philippines"
            );
        ...
        <Marker
          ...
          onClick={() => {
            setCurrentInputAddress(
              "Tierra Monte, Silangan, Rizal, Calabarzon, 1873, Philippines"
            );
