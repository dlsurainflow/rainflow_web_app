...
export const PredictionModule1 = (props) => {
  ...
  const prediction_handler = async () => {
    if (T_A <= 0) {
      ...
      const url = "https://rainflow.live/api/prediction/predict1";
  ...
  return (
    <>
          ...
          <Modal.Title>
            <Pane flex="1" flexDirection="row" backgroundColor="#fff">
              <Pane display="inline-flex" flexDirection="column" padding={10}>
                <Heading size={700}>Area: {editedArea}</Heading>
                ...
                >
                  ...
                  <Pane flex="1" width="100%">
                    <Heading size={100} marginLeft={5} marginTop={10}>
                      {editedArea} RAINFALL RATE (LOWSTREAM)
                    </Heading>
                    <Line
                      data={{
            ...
            {editedArea === "Midstream" ? (
              <>
                ...
                >
                  ...
                  <Pane flex="1" width="100%">
                    <Heading size={100} marginLeft={5} marginTop={10}>
                      {editedArea} RAINFALL RATE (MIDSTREAM)
                    </Heading>
                    <Line
                      data={{
            ...
            {editedArea === "Highstream" ? (
              <>
                ...
                >
                  ...
                  <Pane flex="1" width="100%">
                    <Heading size={100} marginLeft={5} marginTop={10}>
                      {editedArea} RAINFALL RATE (HIGHSTREAM)
                    </Heading>
                    <Line
                      data={{
      ...
      >
        ...
        {/* Lowstream */}
        <Marker
          position={[14.650569571271504, 121.10455520510294]}
          icon={L.icon({
        ...
        <Marker
          position={[14.653865685032384, 121.1204273760795]}
          icon={L.icon({
